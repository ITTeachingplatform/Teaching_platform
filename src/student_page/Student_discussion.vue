<template>
  <div id="student_discussion"  align="center">
      ...
      <router-link to="/student/publish_post"><el-button round style="margin-left:600px;margin-bottom:20px"  >发布讨论</el-button></router-link>
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            <span style="margin-left: 10px">
              ...
              <router-link :to="{name:'Student_publish_post',params:{post_id:scope.row.id}}">{{scope.row.topic }}</router-link>
            </span>
          </template>
        </el-table-column>
